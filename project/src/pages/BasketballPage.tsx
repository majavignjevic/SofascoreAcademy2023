...
function BasketballPage() {
  ...
  useEffect(() => {
    ...
    const basketballTournament = tournaments.find((tournament) => tournament.sport.slug === activeSport.slug);
    if (basketballTournament) {
      setSelectedTournamentId(basketballTournament.id);
    }
  }, [tournaments]);

  return (
    <>
      <MicroLink>Basketball &gt;</MicroLink>
      <ElevationContainer>
